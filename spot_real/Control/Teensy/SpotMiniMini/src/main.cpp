...
void setup() {
  ...
  // SERVOS
  // Shoulders
  FL_Shoulder.Initialize(2, 135, 135, -6.0, FL, Shoulder);  // 0 | 135 mid - 0 out - 270 in
  ...
  BR_Elbow.Initialize(12, 135, 135, 8.0, BR, Elbow); // 7 | 135  mid - 0 in behind - 270 in front
  ...
  BL_Wrist.Initialize(10, 90, 90, 3.0, BL, Wrist); // 10 | 90 straight - 270 bent in
