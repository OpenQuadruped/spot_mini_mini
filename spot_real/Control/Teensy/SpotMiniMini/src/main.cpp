...
void setup() {
  ...
  FL_Shoulder.Initialize(2, 135 + shoulder_liedown, 135, -7.0, FL, Shoulder);  // 0 | 135 mid - 0 out - 270 in
  FR_Shoulder.Initialize(5, 135 - shoulder_liedown, 135, -4.0, FR, Shoulder); // 1 | 135 mid - 270 out - 0 in
  BL_Shoulder.Initialize(8, 135 + shoulder_liedown, 135, -3.0, BL, Shoulder);  // 2 | 135 mid - 0 out - 270 in
  BR_Shoulder.Initialize(11, 135 - shoulder_liedown, 135, -6.5, BR, Shoulder);  // 3 | 135 mid - 270 out - 0 in
  ...
  FL_Wrist.Initialize(4, 90 + wrist_liedown, 90, -2.0, FL, Wrist);  // 8 | 90 straight - 270 bent in
  FR_Wrist.Initialize(7, 180 - wrist_liedown, 180, 6.0, FR, Wrist); // 9 | 180 straight - 0 bent in
  BL_Wrist.Initialize(10, 90 + wrist_liedown, 90, 2.0, BL, Wrist); // 10 | 90 straight - 270 bent in
  BR_Wrist.Initialize(13, 180 - wrist_liedown, 180, 7.0, BR, Wrist); // 11 | 180 straight - 0 bent in
