...
void setup() {
  ...
  BL_Shoulder.Initialize(8, 135 + shoulder_liedown, 135, -3.5, BL, Shoulder);  // 2 | 135 mid - 0 out - 270 in
  BR_Shoulder.Initialize(11, 135 - shoulder_liedown, 135, -5.5, BR, Shoulder);  // 3 | 135 mid - 270 out - 0 in
  ...
  BR_Elbow.Initialize(12, 135 - elbow_liedown, 135, 5.0, BR, Elbow); // 7 | 135  mid - 0 in behind - 270 in front

  //Wrists
  double wrist_liedown = 156.8;
  FL_Wrist.Initialize(4, 90 + wrist_liedown, 90, -4.75, FL, Wrist);  // 8 | 90 straight - 270 bent in
  FR_Wrist.Initialize(7, 180 - wrist_liedown, 180, 8.0, FR, Wrist); // 9 | 180 straight - 0 bent in
