...
void setup() {
  ...
  FL_Shoulder.Initialize(2, 135 + shoulder_liedown, 135, -7.5, FL, Shoulder);  // 0 | 135 mid - 0 out - 270 in
  FR_Shoulder.Initialize(5, 135 - shoulder_liedown, 135, -5.5, FR, Shoulder); // 1 | 135 mid - 270 out - 0 in
  BL_Shoulder.Initialize(8, 135 + shoulder_liedown, 135, -2.5, BL, Shoulder);  // 2 | 135 mid - 0 out - 270 in
  BR_Shoulder.Initialize(11, 135 - shoulder_liedown, 135, -6.0, BR, Shoulder);  // 3 | 135 mid - 270 out - 0 in
  
  //Elbows
  double elbow_liedown = 95.7;
  FL_Elbow.Initialize(3, 135 + elbow_liedown, 135, -4.5, FL, Elbow);  // 4 | 135  mid - 0 in front - 270 behind
  FR_Elbow.Initialize(6, 135 - elbow_liedown, 135, -7.0, FR, Elbow); // 5 | 135  mid - 0 in behind - 270 in front
  BL_Elbow.Initialize(9, 135 + elbow_liedown, 135, 1.5, BL, Elbow);  // 6 | 135  mid - 0 in front - 270 behind
  BR_Elbow.Initialize(12, 135 - elbow_liedown, 135, 8.0, BR, Elbow); // 7 | 135  mid - 0 in behind - 270 in front

  //Wrists
  double wrist_liedown = 156.8;
  FL_Wrist.Initialize(4, 90 + wrist_liedown, 90, -1.0, FL, Wrist);  // 8 | 90 straight - 270 bent in
  FR_Wrist.Initialize(7, 180 - wrist_liedown, 180, 7.0, FR, Wrist); // 9 | 180 straight - 0 bent in
  BL_Wrist.Initialize(10, 90 + wrist_liedown, 90, 1.0, BL, Wrist); // 10 | 90 straight - 270 bent in
